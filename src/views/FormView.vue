        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <div class="space-y-4">
              <div class="bg-primary-50 border-r-4 border-primary-500 p-4 rounded-lg">
                <p class="text-gray-700 leading-relaxed">
                  אני הח"מ נותן כוח ורשות להרב אברהם זכותא שליט"א ועושה אותו שליח ומורשה במקומי לעשות מכירת חמץ לכל מיני
                  חמץ ותערובות חמץ שלי ביום יד' ניסן תשפ"ו. ניתן לראות את נוסח השליחות המלא בהמשך הטופס
                </p>
              </div>
          ...
          <div class="text-center bg-white p-6 rounded-2xl shadow-lg mt-8">
            ...
            <p class="text-lg text-gray-600 mb-6">
              בית הכנסת ''תורת חסד'' - מתחם הסופרים מחלק מאות סלי מזון לקראת חג הפסח, באו ליטול חלק!
            </p>
            ...
            <div class="mt-8">
              <ShareButtons title="שתפו עם חברים ומשפחה"
                text="מכירת חמץ און-ליין וקמחא דפסחא - בית הכנסת ''תורת חסד'' - מתחם הסופרים" size="medium" />
            </div>
          </div>
        </form>
      </div>
