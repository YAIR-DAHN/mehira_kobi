        ...
        <div class="text-center mb-12 bg-white p-8 rounded-2xl shadow-lg transform hover:shadow-xl transition-all duration-300">
          ...
          <!-- <div class="py-4">
            <ShareButtons 
              ...
              text="סייעו למשפחות נזקקות בחג הפסח - קמחא דפסחא של בית הכנסת ''תורת חסד'' - מתחם הסופרים"
              size="large"
            />
          </div> -->
        </div>
            ...
            <div v-if="paymentSuccess" class="bg-green-50 p-6 rounded-lg mt-6 text-center">
              ...
              <div class="py-4">
                <ShareButtons 
                  ...
                  text="הצטרפו אלי לתרומה לקמחא דפסחא לפסח - בית הכנסת ''תורת חסד'' - מתחם הסופרים"
                />
              </div>
        ...
        <div class="text-center p-8 bg-white rounded-2xl shadow-lg" v-if="!showIframe">
          ...
          <div class="py-4">
            <ShareButtons 
              ...
              text="מצוות קמחא דפסחא - בית הכנסת ''תורת חסד'' - מתחם הסופרים"
            />
          </div>
        </div>
      </div>
